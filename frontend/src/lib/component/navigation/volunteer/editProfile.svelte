<script>
	...
	import ModalEditProfile from '../../modal/modalEditProfile.svelte';
	...
	<div class="card p-6 space-y-6 shadow-xl text-left">
		{#if userDetail}
			<form class="space-y-4">
				...
				<button type="button" class="btn variant-filled-primary w-full" on:click={modalEditProfile}>Edit</button>
				<button type="button" class="btn variant-filled-error w-full">Delete</button>
			</form>
		{:else}
